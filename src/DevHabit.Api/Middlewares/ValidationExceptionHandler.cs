...
public sealed partial class ValidationExceptionHandler(IProblemDetailsService problemDetailsService) : IExceptionHandler
{
    ...
    // <summary>
    //     Convert a string in PascalCase format to camelCase,
